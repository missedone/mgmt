...
// TODO: should this be named FuncCallArgsValueInvariant or something different or not?
...
func (obj *CallFuncArgsValueInvariant) String() string {
	return fmt.Sprintf("%p == callfuncargs(%p) %p", obj.Expr, obj.Func, obj.Args) // XXX !!!
}
